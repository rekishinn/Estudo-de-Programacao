package Collection_ArrayList_e_Vector_exemplo002.src;

import java.util.ArrayList;

public class Collection_ArrayList_e_Vector_exemplo002 {
    public static void main(String[] args) {
        ...
        listaNome.remove(0); //vai remover o elemento da posição 0
